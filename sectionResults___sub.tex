...
We filtered the {\em D. virilis} genes for those with at least FIXMEFIXME-1mappedfragment--FIXMEFIXME in the sample with 20\% {\em D. virilis}, then calculated an independent linear regression for each of those genes.  As expected, for every protocol, the mean slope was within one fourth of a standard deviation of 1.  Similarly, the intercepts were all within one fourth of a standard deviation of zero.  Also unsurprisingly, the TruSeq protocol had a noticeably higher mean correlation coefficient ($0.94 \pm 0.08$) than any of the other protocols ($0.89 \pm 0.14$, $0.82\pm0.20$, and $0.88 \pm 0.16$ for Clontech, TotalScript, and SMART-seq2, respectively). Although the mean correlation coefficient was statistically significantly higher for the Clontech samples than for the SMART-seq2 samples ($t$-test $p = 1.18 \times 10^{-5}$), for practical purposes their distributions of correlation coefficients was identical (Figure \ref{fig:fithists}).
